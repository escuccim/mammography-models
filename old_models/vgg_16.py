...
# vgg_16.01 - updated code to match other models, while evaluate again
...
with graph.as_default():
    ...
    conv1 = _conv2d_batch_norm(X_adj, 64, kernel_size=(3,3), stride=(1,1), training=training, epsilon=1e-8, padding="VALID", seed=100, lambd=lamC, name="1.1")
