...
with tf.Session(graph=graph, config=config) as sess:
    ...
    if init:
        ...
        if init_model is not None:
            ...
            init_fn = load_weights(init_model, exclude=["up_conv5", "up_conv4", "up_conv3","up_conv2","up_conv1","conv9", "bn9", "conv8", "bn8","conv6", "bn6", "conv7", "bn7","fcn_logits", "logits", "global_step"])
