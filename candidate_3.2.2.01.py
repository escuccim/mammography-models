...
with tf.Session(graph=graph, config=config) as sess:
    ...
    if init:
        ...
        if init_model is not None:
            ...
            init_fn = load_weights(init_model, exclude=["fc3", "bn_conv6", "up_conv7",   "bn_up_conv8","bn_up_conv6","bn_up_conv7","conv_up_conv6", "conv_up_conv8","up_conv2","up_conv5","up_conv6", "accuracy", "up_conv4", "up_conv3", "global_step"])
