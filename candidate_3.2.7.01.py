...
with tf.Session(graph=graph, config=config) as sess:
    ...
    if init:
        ...
        if init_model is not None:
            ...
            init_fn = load_weights(init_model, exclude=["logits", "bn_unpool8", "up_conv8", "bn_unpool7", "bn_upconv7", "up_conv7", "up_conv6", "bn_unpool6", "bn_unpool5.1", "up_conv5", "bottleneck_2.1", "bn_unpool4.1", "up_conv4", "bottleneck_3.1", "bn_unpool3.1", "up_conv3", "bottleneck_4.1", "bn_unpool2.1", "up_conv2", "bn_unpool5"])
